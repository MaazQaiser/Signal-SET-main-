...
const VisitorDetails = ({ siteId, visitorId, setShowDrawer, onSubmit, disableButton }) => {
  ...
  const SecondaryBarElement = ({ data }) => (
    <Box className={classes.StatsWrapper}>
      <Box className={classes.statsList}>
        ...
        <Typography variant="button" className={classes.labelData}>
          {data?.lastVisit ? formatDate(data?.lastVisit) : NA}
        </Typography>
      </Box>
      <Box className={classes.statsList}>
        <Typography variant="body3" className={classes.label}>
        ...
        <Typography variant="button" className={classes.labelData}>
          {data?.lastCheckin ? formatDate(data?.lastCheckin, 'hh:mm A') : NA}
        </Typography>
      </Box>
      <Box className={classes.statsList}>
        <Typography variant="body3" className={classes.label}>
        ...
        <Typography variant="button" className={classes.labelData}>
          {data?.lastCheckout ? formatDate(data?.lastCheckout, 'hh:mm A') : NA}
        </Typography>
      </Box>
      <Box className={classes.statsList}>
        <Typography variant="body3" className={classes.label}>
