  ...
  return (
    ...
    >
      ...
      <Box className={classes.createTemplateBtns}>
        {showCancel && (
          <Button disabled={disabled} onClick={handleCancel} variant="secondaryGrey">
            {t('links.cancel')}
          </Button>
        )}
        {isEdit && (
          <Button disabled={disabled} onClick={handleEdit} variant="primary">
            {t('links.edit')}
          </Button>
        )}
        {showSave && (
          <Button disabled={disabled} onClick={handleSave} variant="primary">
            {t('links.save')}
          </Button>
        )}
      </Box>
