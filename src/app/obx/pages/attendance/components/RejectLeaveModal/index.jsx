...
const RejectLeaveModal = ({ open, handleClose, onSubmit, isLoading }) => {
  ...
  const rejectLeaveModalBody = (
    <Box className={classes.rejectLeaveModalBody}>
      ...
      <Box className={classes.rejectLeaveModalBodyField}>
        <TextField
          placeholder={t('obx.attendance.pendingAttendanceRequestModal.addComment')}
          minRows={5}
          maxRows={5}
          multiline
