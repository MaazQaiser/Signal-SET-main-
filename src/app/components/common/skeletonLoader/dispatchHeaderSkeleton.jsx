...
const DispatchHeaderSkeleton = ({ className, numberOfStatusItem, hasImage }) => {
...
DispatchHeaderSkeleton.defaultProps = {
  numberOfStatusItem: 3,
  hasImage: true,
};

DispatchHeaderSkeleton.propTypes = {
  className: PropTypes.object,
  numberOfStatusItem: PropTypes.number,
  hasImage: PropTypes.bool,
};
export default DispatchHeaderSkeleton;
