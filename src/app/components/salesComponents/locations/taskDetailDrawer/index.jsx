...
import TaskType from 'salesComponents/locations/taskTabs/taskType';
...
import { checkIfDateIsPassed, formatDate } from 'src/helper/utilityFunctions';
import RenderIfHasPermission from 'src/hoc/renderIfHasPermission';
import { getDisplayConfiguration } from 'src/redux/store/slices/regionalCountryConfiguration';
import userHasPermission from 'src/utils/auth/userHasPermission';

import NewTaskDrawer from '../../locations/newTaskDrawer';
          ...
          <Box className={classes.taskistWrapper}>
            <Box className={classes.taskist}>
              ...
              <Typography variant="subtitle2" className={classes.taskistText}>
                {formatDate(dueDate, `${dateFormat} h:mm A`)}
              </Typography>
